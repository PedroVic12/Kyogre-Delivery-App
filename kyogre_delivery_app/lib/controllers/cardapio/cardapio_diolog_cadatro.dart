...
import 'package:kyogre_delivery_app/controllers/photo_gallery_controller.dart';
import 'package:kyogre_delivery_app/widgets/CustomText.dart';
import 'package:kyogre_delivery_app/widgets/FormSimples.dart';
...
class _CadastroDialogState extends State<CadastroDialog> {
  ...
  Widget pickImageToCarrousel() {
    final controller = PhotoGalleryController();
  ...
  Widget carrouselImagens() {
    return Container(
      ...
      child: CarouselView(
          itemExtent: 200, children: [Image.network(imagemSelecionada!.path)]),
    );

    // GetBuilder<PhotoGalleryController>(
    //   builder: (controller) {
