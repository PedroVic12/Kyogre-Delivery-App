...
import 'package:kyogre_delivery_app/controllers/admin/user_admin_controller.dart';
...
class _NightWolfAppBarState extends State<NightWolfAppBar> {
  bool _isPurple = true;
  final ControleUsuariosCliente usuariosController = ControleUsuariosCliente();
