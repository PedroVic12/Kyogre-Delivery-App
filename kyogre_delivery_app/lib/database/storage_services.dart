...
import 'package:kyogre_delivery_app/app/models/ProdutoModel.dart';
...
class FirebaseServices {
  ...
  // Recuperar a lista de produtos do Firestore
  Stream<List<ProdutoModel>> getProdutos() {
    return _firestore.collection('produtos').snapshots().map((snapshot) {
      return snapshot.docs
          .map((doc) => ProdutoModel.fromMap(doc.data()))
          .toList();
    });
  }
}
